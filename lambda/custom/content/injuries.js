module.exports = {
   ...
   INJURIES_EN_US: {
      ...
      // 'stroke': [
      //    {
      //       'text': 'Remember the acronym FAST, F A S T. The F stands for face, is there weakness on one side of the face?'
      //    },
      //    {
      //       'text': 'A is for arms, can they raise both arms?'
      //    },
      //    {
      //       'text': 'The S stands for speech, is their speech easily understood or slurred?'
      //    },
      //    {
      //       'text': 'The T is for time, time to call 911.'
      //    },
      //    {
      //       'text': 'Talk to the person to reassure them while you wait for the ambulance.'
      //    }
      // ],
      // 'unresponsive': [
      //    {
   ...
   INJURIES_EN_GB: {
      ...
      'poisoning': [
         ...
         {
            'text': 'As soon as possible, call 111 for poison advice.'
         },
         {
      ...
      'stroke': [
         ...
         {
            'text': 'The T is for time, time to call 999.'
         },
         {
            'text': 'Talk to the person to reassure them while you wait for the ambulance.'
         }
